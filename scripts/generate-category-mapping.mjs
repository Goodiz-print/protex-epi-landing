...
const RULES = [
	...
	{ category: 'mains', subcategory: 'hygiene-sante', keywords: ['hygiene', 'gel hydroalcoolique', 'savon', 'creme', 'pommade'] },
	{ category: 'mains', subcategory: 'gants-protection', keywords: ['gant'] },

	// TETE (order matters: ouie/yeux/respiratoire before generic casque)
	{ category: 'tete', subcategory: 'protection-ouie', keywords: ["bouchon d'oreille", 'bouchon auditif', 'anti-bruit', 'casque anti-bruit', 'protection auditive', 'bouchons'] },
	{ category: 'tete', subcategory: 'protection-yeux', keywords: ['lunette', 'visiere', 'ecran facial', 'surlunette'] },
	...
	{ category: 'tete', subcategory: 'protection-tete', keywords: ['casque', 'casquette anti-heurt', 'bump cap'] },

	// CORPS
	{ category: 'corps', subcategory: 'vetements-haute-visibilite', keywords: ['haute visibilite', 'hi-vis', 'fluo'] },
	{ category: 'corps', subcategory: 'vetements-pluie', keywords: ['pluie', 'impermeable', 'k-way', 'cire'] },
	{ category: 'corps', subcategory: 'equipement-antichute', keywords: ['harnais', 'antichute', 'longe', 'ligne de vie', "point d'ancrage"] },
	{
		category: 'corps',
		...
		keywords: [
			...
			'doudoune', 'parka', 'bermuda',
		],
	},

	// PIEDS (specific before generic)
	{ category: 'pieds', subcategory: 'accessoires-chaussures', keywords: ['lacet', 'semelle', 'sur-chaussure', 'guetre'] },
	...
	{ category: 'pieds', subcategory: 'chaussures-basses', keywords: ['chaussure basse', 'basket de securite', 'chaussure'] },
...
function main() {
	...
	for (const row of rows) {
		...
		if (!firstSeenByStyleCode.has(styleCode)) {
			firstSeenByStyleCode.set(styleCode, { product: row['Product'], description: row['Description'] });
		}
	}
