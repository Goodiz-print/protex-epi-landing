...
for (const supplier of SUPPLIERS) {
	...
	// 1. Mapping: overwrite (or add) the entry for every overridden style code.
	...
	// 2. Committed catalog: patch every colourway of the overridden style codes.
	...
	for (const product of products) {
		...
		unknown.delete(product.styleCode);
