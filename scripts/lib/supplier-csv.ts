// Grouping / joining / mapping logic for the raw supplier CSV exports.
//
// Used only by scripts/generate-catalog-data.mjs, which is run manually — never by
// `astro dev`/`astro build`. The build reads the JSON this produces, via
// src/content/loaders/json-products-loader.ts.

import { slugify } from '../../src/utils/slugify.ts';
import type { Product } from '../../src/content/schemas/product.ts';
